...
def main():
    ...
    with open('Gesture/Hand/model/keypoint_classifier/keypoint_classifier_label.csv',
    ...
    with open(
            'Gesture/Hand/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
...
<<<<<<< HEAD:Gesture/Hand/app.py
        


        # Camera capture #####################################################
=======
>>>>>>> 2ce202f77d4d8698725ca87aee0415104b60a142:Gesture/Hand/main.py
        ret, image = cap.read()
        if not ret:
            break
