...
def main():
    ...
    # Read labels ###########################################################
    with open('Gesture/Hand/Client_2/model/keypoint_classifier/keypoint_classifier_label.csv',
    ...
    with open(
            'Gesture/Hand/Client_2/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
    ...
    while True:
        ...
        if key == 110:
            # csv_path = 'Gesture/Hand/Client_2/model/keypoint_classifier/keypoint.csv'
            # csv_path_label = 'Gesture/Hand/Client_2/model/keypoint_classifier/keypoint_classifier_label.csv'
...
def logging_csv(number, mode, landmark_list, point_history_list):
    ...
    if mode == 2 and (0 <= number <= 9):
        csv_path = 'Gesture/Hand/Client_2/model/point_history_classifier/point_history.csv'
        with open(csv_path, 'a', newline="") as f:
            writer = csv.writer(f)
