...
with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
    ...
    while cap.isOpened():
        ...
        # Obtaining Landmark Coordinates for Krounchasana
        ...
        # Calculating the Angles required for Krounchasana
        ...
        # Check if Krounchasana Conditions are met
        ...
        if ((left_knee_angle > 55) and (left_knee_angle < 85)) and ((right_knee_angle > 0) and (right_knee_angle < 40)) or ((left_knee_angle > 0) and (left_knee_angle < 40)) or ((right_knee_angle > 55) and (right_knee_angle < 85)):
        ...
        cv2.imshow("Krounchasana Pose", frame)
