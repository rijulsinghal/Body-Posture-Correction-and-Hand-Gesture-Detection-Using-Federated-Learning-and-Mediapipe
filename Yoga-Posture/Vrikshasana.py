...
def main():
    ...
    with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
        ...
        while cap.isOpened():
            ...
            # # # Check if Left Elbow is at 30 deg from wrist
            if (left_elbow_angle > 145) and (left_elbow_angle < 155):
            ...
            if (right_elbow_angle > 145) and (right_elbow_angle < 155):
            ...
            # # # Check Left Shoulder
            if (left_shoulder_angle > 165) and (left_shoulder_angle < 180):
            ...
            if (right_shoulder_angle > 165) and (right_shoulder_angle < 180):
            ...
            if ((left_knee_angle > 280) and (left_knee_angle < 305)) and ((right_knee_angle > 170) and (right_knee_angle < 185)) or ((left_knee_angle > 170) and (left_knee_angle < 185)) or ((right_knee_angle > 280) and (right_knee_angle < 305)):
                cv2.putText(frame, 'Left Knee Angle: ' + str(round(left_knee_angle, 1)), 
                            tuple(np.multiply([left_knee_x, left_knee_y], window_size).astype(int)),
                            2, 0.5, green, 1)
                cv2.putText(frame, 'Right Knee Angle: ' + str(round(right_knee_angle, 1)), 
