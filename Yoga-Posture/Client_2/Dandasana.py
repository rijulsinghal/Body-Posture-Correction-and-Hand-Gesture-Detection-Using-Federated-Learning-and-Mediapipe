...
def main():
    ...
    with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
        ...
        while cap.isOpened():
            ...
            # Obtaining Landmark Coordinates for Dandasana
            ...
            # Calculating the Angles required for Dandasana
            ...
            if (left_hip_angle > 85) and (left_hip_angle < 95):
            ...
            if (right_hip_angle > 85) and (right_hip_angle < 95):
            ...
            # cv2.imshow("Dandasana Pose", frame)
