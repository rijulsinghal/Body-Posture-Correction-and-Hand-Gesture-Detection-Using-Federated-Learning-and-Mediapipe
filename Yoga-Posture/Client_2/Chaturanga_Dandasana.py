...
def main():
    ...
    with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
        ...
        while cap.isOpened():
            ...
            # Obtaining Landmark Coordinates for Chaturanga Dandasana
            ...
            # Calculating the Angles required for Chaturanga Dandasana
            ...
            # Check if Dandasana Conditions are met
            # # Check if Elbows are in position
            # # # Check if Left Elbow is making a right angle
            if (left_elbow_angle > 80) and (left_elbow_angle < 100):
            ...
            if (right_elbow_angle > 80) and (right_elbow_angle < 100):
            ...
            if (left_hip_angle > 170) and (left_hip_angle < 190):
            ...
            if (right_hip_angle > 170) and (right_hip_angle < 190):
            ...
            # cv2.imshow("Chaturanga Dandasana Pose", frame)
