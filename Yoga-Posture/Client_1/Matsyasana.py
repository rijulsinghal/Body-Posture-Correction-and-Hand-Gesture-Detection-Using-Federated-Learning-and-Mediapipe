...
def main():
    ...
    with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
        ...
        while cap.isOpened():
            ...
            # Obtaining Landmark Coordinates for Matsyasana
            ...
            # Calculating the Angles required for Matsyasana
            ...
            # Check if Matsyasana Conditions are met
            # # Check if Elbows are Straight
            # # # Check if Left Elbow is Straight
            if (left_elbow_angle > 120) and (left_elbow_angle < 150):
            ...
            if (right_elbow_angle > 120) and (right_elbow_angle < 150):
            ...
            if (left_hip_angle > 150) and (left_hip_angle < 180):
            ...
            if (right_hip_angle > 150) and (right_hip_angle < 180):
            ...
            # cv2.imshow("Matsyasana Pose", frame)
