...
def main():
    ...
    with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
        ...
        while cap.isOpened():
            ...
            # Obtaining Landmark Coordinates for Purvottanasana
            ...
            # Calculating the Angles required for Purvottanasana
            ...
            # Check if Purvottanasana Conditions are met
            ...
            if (right_elbow_angle > 160) and (right_elbow_angle < 200):
            ...
            # # # Check Left Shoulder
            if (left_shoulder_angle > 60) and (left_shoulder_angle < 90):
            ...
            if (right_shoulder_angle > 60) and (right_shoulder_angle < 90):
            ...
            if (left_hip_angle > 160) and (left_hip_angle < 200):
            ...
            if (right_hip_angle > 160) and (right_hip_angle < 200):
            ...
            # cv2.imshow("Purvottanasana Pose", frame)
