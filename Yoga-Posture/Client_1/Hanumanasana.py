...
def main():
    ...
    with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
        ...
        while cap.isOpened():
            ...
            # Obtaining Landmark Coordinates for Hanumanasana
            ...
            # Calculating the Angles required for Hanumanasana
            ...
            # Check if Hanumanasana Conditions are met
            ...
            # # # Check Left Shoulder
            if (left_shoulder_angle > 160) and (left_shoulder_angle < 200):
            ...
            if (left_hip_angle > 70) and (left_hip_angle < 110):
            ...
            if (right_hip_angle > 70) and (right_hip_angle < 110):
            ...
            if (left_knee_angle > 160) and (left_knee_angle < 200):
            ...
            if (right_knee_angle > 160) and (right_knee_angle < 200):
            ...
            # cv2.imshow("Hanumanasana Pose", frame)
