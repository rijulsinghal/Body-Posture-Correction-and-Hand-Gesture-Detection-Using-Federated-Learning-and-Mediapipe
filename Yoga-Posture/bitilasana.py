...
with mp_holisitic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5) as holistic:
    ...
    while cap.isOpened():
        ...
        # Obtaining Landmark Coordinates for Bitilasana
        ...
        # Calculating the Angles required for Bitilasana
        ...
        # Check if Bitilasana Conditions are met
        ...
        if (left_knee_angle > 70) and (left_knee_angle < 110):
        ...
        if (right_knee_angle > 70) and (right_knee_angle < 110):
